...
```
+-------------------------------------------------------------------------+
|              AI Threat Detection System  v2.0.0                         |
|                    Enterprise SOC Platform                              |
+-------------------------------------------------------------------------+
                                   |
                                   v
+-------------------------------------------------------------------------+
|  PRESENTATION LAYER  -  React 18 + Vite + TypeScript  (Port 3000)       |
|                                                                         |
|  Dashboard  Logs  Alerts  Anomalies  Incidents  Event Viewer            |
|  SOAR  Threat Intel  Investigation  SOC Assistant (AI Chat)             |
+----------------------------------+--------------------------------------+
                                   |  REST API + WebSocket
                                   v
+-------------------------------------------------------------------------+
|  API LAYER  -  FastAPI  (Python 3.12, async)  -  Port 8000              |
|                                                                         |
...
|  |  explain / stream   |  |  live stream        |  |  abstraction    | |
|  +---------------------+  +---------------------+  +-----------------+ |
+----------------------------------+--------------------------------------+
                                   |
                                   v
...
|  |  IsolationForest + LOF       |  |  - Async non-blocking train    |   |
|  |  ensemble  score 0-1         |  |  - Auto-train from DB on start |   |
|  |                              |  |  - Model persistence to disk   |   |
|  +------------------------------+  |  - Scheduled retrain (24h)     |   |
|                                    +--------------------------------+   |
|  +-------------------------------------------------------------------+  |
|  |  Feature Engineering  -  IP / port patterns / traffic / time      |  |
|  +-------------------------------------------------------------------+  |
+----------------------------------+--------------------------------------+
                                   |
           +-----------------------+-----------------------+
...
|  SQLAlchemy 2 async |  |                     |  |  Llama3 / Gemma     |
|                     |  |  - SOAR blacklist   |  |                     |
|  - Log entries      |  |  - Correlation state|  |  - Threat explain   |
|  - Alerts           |  |  - Behavioral prof. |  |  - SOC assistant    |
|  - Incidents        |  |  - TI / alert cache |  |  - MITRE TTPs       |
|  - Threat Intel     |  |  - Event stream     |  |  - Remediation      |
|  - Blacklist        |  |  - Rule engine state|  |                     |
|  - Rules            |  |                     |  |  (graceful fallback |
|  - Anomalies        |  |                     |  |   when offline)     |
+---------------------+  +---------------------+  +---------------------+
```
